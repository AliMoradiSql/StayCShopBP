...
{
    public abstract class StayCShopWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static StayCShopWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(StayCShopWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<StayCShopDbContext> action)
        {
            using (var context = IocManager.Resolve<StayCShopDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<StayCShopDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<StayCShopDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<StayCShopDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<StayCShopDbContext, Task<T>> func)
        {
            T result;
